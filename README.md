...
- 注意事项：
  ...
  3. 同组同模型重复提交会覆盖！
  4. TXT文件严禁传播，提交不属于本组的TXT文件按作弊处理！
  5. 各组妥善保存对应模型参数以备查验！
...
- 第一阶段测试：11月18日00:00:00开放提交，11月20日23:59:59停止提交。提交链接：http://116.56.134.138/files/%E5%A4%A7%E4%BD%9C%E4%B8%9A/step6_%E6%B5%8B%E8%AF%95%E7%BB%93%E6%9E%9C%E4%B8%8A%E4%BC%A0/stage1 (TODO: update time)
- 第二阶段测试：11月22日00:00:00开放提交，11月24日23:59:59停止提交。提交链接：http://116.56.134.138/files/%E5%A4%A7%E4%BD%9C%E4%B8%9A/step6_%E6%B5%8B%E8%AF%95%E7%BB%93%E6%9E%9C%E4%B8%8A%E4%BC%A0/stage2 (TODO: update time)

### 7.3 提交内容

两个 `.txt` 文件，**留意文件命名**，有几个组员就在文件名字里写几个。这部分是脚本自动评分的所以命名不规范后果自负。

- `姓名1_姓名2_pred.txt`: 每一行表示测试集中的图片对应的预测结果。
一个提交示例如图：
    <div align="center">
    <img src="images/11.jpg" width = "600"/>
    </div>

- `姓名1_姓名2_complexity.txt`: 第一行表示模型 1 的模型复杂度（单位 Mac），第二行表示模型 2 的模型复杂度。统一使用科学计数法，保留小数点后两位（如 1.03e10 Mac）
...
### 8.1 答辩
- 日期：(TODO: update time)11月26日（第13周周六上午）
- 时间：8：30 ~ 12：30
- 地点：线上腾讯会议
- 时长：5分钟PPT + 3~5分钟提问
